...
namespace Azurlane
{
    ...
    internal static class Program
    {
        ...
        {
            Console.WriteLine("[INFO]> Usage: Azurlane.exe <option> <path-to-file(s) or path-to-directory(s)");
            Console.WriteLine("[INFO]> You can input multiple files or directories, Lua & AssetBundle are the only acceptable file.");
            Console.WriteLine();
